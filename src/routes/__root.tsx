...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Write, edit, and publish with an AI-powered editorial CMS." },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Ink — AI-powered editorial CMS" },
      { property: "og:description", content: "Write, edit, and publish with an AI-powered editorial CMS." },
    ],
